...
| [0003](./0003-agency-sdk-service-auth.md) | Agency SDK — service auth, public reads, hub resolve | Accepted — M0–M5 ([#89](https://github.com/ingmarstruijs/WikiTraveler/issues/89)) |
